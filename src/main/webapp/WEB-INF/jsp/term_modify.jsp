...
<div class="navP">
  ...
  <p class="p1">Для модификации семестра отредактируйте данные и нажмите кнопку "Применить":</p>
</div>
...
<div class="ST">
  <div class="input22">
    ...
    <label class="label1">Длительность (в неделях)
      <input class="input222" type="text" id="durationDiscipline" name="term">
    </label>
  ...
  <div class="button6"><button onclick="createTerm()" class="button66">Применить</button></div>
</div>

<form action="/term_modify" method="post" id="disciplinesForTerm">
